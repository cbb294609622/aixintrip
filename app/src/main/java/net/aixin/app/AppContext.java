...
import net.aixin.app.base.BaseApplication;
import net.aixin.app.bean.Constants;
import net.aixin.app.bean.User;
import net.aixin.app.cache.DataCleanManager;
import net.aixin.app.util.CyptoUtils;
...
import static net.aixin.app.AppConfig.KEY_FRITST_START;
import static net.aixin.app.AppConfig.KEY_LOAD_IMAGE;
import static net.aixin.app.AppConfig.KEY_NIGHT_MODE_SWITCH;
import static net.aixin.app.AppConfig.KEY_TWEET_DRAFT;
