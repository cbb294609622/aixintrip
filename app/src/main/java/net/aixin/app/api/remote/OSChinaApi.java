package net.aixin.app.api.remote;
...
import net.aixin.app.AppException;
import net.aixin.app.api.ApiHttpClient;
import net.aixin.app.bean.EventApplyData;
...
public class OSChinaApi {
     ...
     * @param handler
     */
    public static void aixinLogin(String moblie,String password,AsyncHttpResponseHandler handler){
        RequestParams params = new RequestParams();
        params.put("mobile", moblie);
        params.put("password", password);
        String loginurl = "http://api.aixintrip.net/app/login/login";
        ApiHttpClient.post(loginurl, params, handler);
    }
    ...
    public static void getNewsList(int catalog, int page,
        ...
        ApiHttpClient.aixinGet("http://api.aixintrip.net/app/product/lists", params, handler);
    }
    ...
    public static void getBlogList(String type, int pageIndex,
        ...
        params.put("pageSize", AppContext.PAGE_SIZE);
        ApiHttpClient.get("http://api.aixintrip.net/app/news/lists", params, handler);
    }

    /**
     * 旅游问答的请求（提问，分享，综合，职业，站务）
     * @param catalog
     * @param page
     * @param handler
     */
    public static void getPostList(int catalog, int page,
        ...
        params.put("pageIndex", page);
        params.put("pageSize", AppContext.PAGE_SIZE);
        ApiHttpClient.aixinGet("http://api.aixintrip.net/app/onlinepost/lists", params, handler);
    }
    ...
    public static void getActiveList(int uid, int catalog, int page,
        ...
        params.put("pageIndex", page);
        params.put("pageSize", AppContext.PAGE_SIZE);
        ApiHttpClient.get("http://api.aixintrip.net/app/notice/lists", params, handler);
    }
 ...
 /**
     ...
     * @param handler
     */
    public static void getSoftWareAllList(int tag, AsyncHttpResponseHandler handler){
        ApiHttpClient.get("http://api.aixintrip.net/app/product/category?tag="+tag, null, handler);
    }
     ...
     * @param handler
     */
    public static void aixinGetMyInformation(int uid,AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams();
//        params.put("uid", uid);
        ApiHttpClient.get("http://api.aixintrip.net/app/login/login?uid="+uid, params, handler);
    }
    ...
    public static void getNewsDetail(int id, AsyncHttpResponseHandler handler) {
        ...
        ApiHttpClient.get("http://api.aixintrip.net/app/product/detail?aid="+id,handler);
    }
    ...
    public static void getBlogDetail(int id, AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams("id", id);
        ApiHttpClient.get("http://api.aixintrip.net/app/news/detail?id="+id, handler);
    }
    ...
    public static void getTweetDetail(int id, AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams("id", id);
        ApiHttpClient.get("http:action/api/tweet_detail", params, handler);
    }
    ...
    public static void shake(int type, AsyncHttpResponseHandler handler) {
        String inter = "http://api.aixintrip.net/app/rock/run";
        if (type > 0) {
     ...
     * @param handler
     */
    public static void get_technical_send(String t,String u,String c,String a, AsyncHttpResponseHandler handler){
        ApiHttpClient.getDirect("http://m.aixintrip.net/api.php?t=73f5c138&u=123&c=post&a=gettypes", handler);
    }
     ...
     * @param handler
     */
    public static void send_post(TechnicalBean bean,AsyncHttpResponseHandler handler){
        String url = "http://m.aixintrip.net/api.php?t=73f5c138&u=123&c=post&a=set";

        RequestParams params = new RequestParams();
        params.put("title", bean.title);
        params.put("content", bean.connt);
        params.put("type",bean.type);

        if (!TextUtils.isEmpty(bean.imgFile)) {
            try {
                params.put("img", new File(bean.imgFile));
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
        }
        ApiHttpClient.postDirect(url, params, handler);
    }
}
