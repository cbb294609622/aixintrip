...
import net.aixin.app.team.adapter.TeamReplyAdapter;
import net.aixin.app.team.bean.TeamActive;
import net.aixin.app.team.bean.TeamActiveDetail;
import net.aixin.app.team.bean.TeamRepliesList;
import net.aixin.app.team.bean.TeamReply;
