...
import net.aixin.app.bean.NotebookData;
import net.aixin.app.bean.NotebookDataList;
import net.aixin.app.bean.SimpleBackPage;
import net.aixin.app.bean.User;
import net.aixin.app.db.NoteDatabase;
import net.aixin.app.team.adapter.NotebookAdapter;
import net.aixin.app.ui.empty.EmptyLayout;
import net.aixin.app.util.KJAnimations;
import net.aixin.app.util.SynchronizeController;
import net.aixin.app.util.SynchronizeController.SynchronizeListener;
import net.aixin.app.util.UIHelper;
import net.aixin.app.util.XmlUtils;
import net.aixin.app.widget.KJDragGridView;
import net.aixin.app.widget.KJDragGridView.OnDeleteListener;
import net.aixin.app.widget.KJDragGridView.OnMoveListener;
