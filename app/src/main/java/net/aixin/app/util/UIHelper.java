...
import net.aixin.app.bean.Active;
import net.aixin.app.bean.Comment;
import net.aixin.app.bean.Constants;
import net.aixin.app.bean.News;
import net.aixin.app.bean.Notice;
import net.aixin.app.bean.ShakeObject;
...
import net.aixin.app.fragment.FriendsFragment;
...
import net.aixin.app.interest.ui.InterestMainActivity;
import net.aixin.app.interf.ICallbackResult;
import net.aixin.app.interf.OnWebViewImageListener;
import net.aixin.app.service.DownloadService;
import net.aixin.app.service.DownloadService.DownloadBinder;
import net.aixin.app.service.NoticeService;
import net.aixin.app.team.adapter.TeamMemberAdapter;
import net.aixin.app.team.bean.Team;
import net.aixin.app.team.bean.TeamActive;
import net.aixin.app.team.bean.TeamDiscuss;
import net.aixin.app.team.bean.TeamIssue;
import net.aixin.app.team.bean.TeamIssueCatalog;
import net.aixin.app.team.bean.TeamMember;
...
import net.aixin.app.team.ui.TeamNewIssueActivity;
import net.aixin.app.ui.DetailActivity;
import net.aixin.app.ui.EventLocationActivity;
import net.aixin.app.ui.ImagePreviewActivity;
import net.aixin.app.ui.LoginActivity;
import net.aixin.app.ui.SimpleBackActivity;
import net.aixin.app.ui.TweetActivity;
...
public class UIHelper {
     ...
     * @param context
     */
    public static void showInterestMainActivity(Context context) {
        Intent intent = new Intent(context, InterestMainActivity.class);
        context.startActivity(intent);
    }
