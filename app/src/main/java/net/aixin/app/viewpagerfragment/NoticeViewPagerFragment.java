...
import net.aixin.app.bean.ActiveList;
...
import net.aixin.app.fragment.MessageFragment;
import net.aixin.app.fragment.TweetsLikesFragment;
import net.aixin.app.ui.MainActivity;
import net.aixin.app.widget.BadgeView;
import net.aixin.app.widget.PagerSlidingTabStrip.OnPagerChangeLis;
