...
import net.aixin.app.adapter.RecyclingPagerAdapter;
...
import net.aixin.app.ui.dialog.ImageMenuDialog;
import net.aixin.app.ui.dialog.ImageMenuDialog.OnMenuClickListener;
import net.aixin.app.util.TDevice;
import net.aixin.app.util.UIHelper;
import net.aixin.app.widget.HackyViewPager;
