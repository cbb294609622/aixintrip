...
import net.aixin.app.base.CommonDetailFragment;
import net.aixin.app.emoji.KJEmojiFragment;
import net.aixin.app.emoji.OnSendClickListener;
import net.aixin.app.emoji.ToolbarFragment;
import net.aixin.app.emoji.ToolbarFragment.OnActionClickListener;
import net.aixin.app.emoji.ToolbarFragment.ToolAction;
import net.aixin.app.fragment.BlogDetailFragment;
import net.aixin.app.fragment.CommentFrament;
import net.aixin.app.fragment.EventDetailFragment;
import net.aixin.app.fragment.NewsDetailFragment;
import net.aixin.app.fragment.PostDetailFragment;
import net.aixin.app.fragment.SoftwareDetailFragment;
import net.aixin.app.fragment.TweetDetailFragment;
import net.aixin.app.team.fragment.TeamDiaryDetailFragment;
import net.aixin.app.team.fragment.TeamDiscussDetailFragment;
import net.aixin.app.team.fragment.TeamIssueDetailFragment;
import net.aixin.app.team.fragment.TeamTweetDetailFragment;
