...
public class SimpleBackActivity extends BaseActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.chat_friend_home:
                ...
                break;
            case R.id.technical_send_post://进入发帖页面
                if (mFragment.get() instanceof QuestViewPagerFragment) {
                    //点击后做自己的事
                    UIHelper.showSimpleBack(this, SimpleBackPage.TECHNIACL_SEND_POST);
                } else {
                    return super.onOptionsItemSelected(item);
                }
                break;
            case R.id.submit_post://提交编辑好的发帖内容
                if (mFragment.get() instanceof TechnicalSendPostFragment){
                    ((TechnicalSendPostFragment) mFragment.get()).sendPost();
                }else{
                    return super.onOptionsItemSelected(item);
                }
                break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        } else if(mFragment.get() instanceof QuestViewPagerFragment){
            getMenuInflater().inflate(R.menu.technial_send_post_item, menu);
        } else if (mFragment.get() instanceof TechnicalSendPostFragment){
