...
import net.aixin.app.bean.LoginUserBean;
import net.aixin.app.bean.OpenIdCatalog;
...
public class LoginActivity extends BaseActivity implements IUiListener {
    ...
    private void handleLogin() {
        ...
        OSChinaApi.aixinLogin(mUserName, mPassword, mHandler);
    }
    ...
    private void handleLoginBean(LoginUserBean loginUserBean) {
        if (loginUserBean.getResult().OK()) {
            ...
            //爱信cookie加入进来，不保存
            boolean aixinCookie = true;
            if (!aixinCookie && cookies != null) {
                String tmpcookies = "";
