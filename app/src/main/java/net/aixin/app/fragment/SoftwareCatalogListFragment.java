...
import net.aixin.app.adapter.SoftwareCatalogListAdapter;
...
import net.aixin.app.bean.SoftwareCatalogList;
...
import net.aixin.app.widget.ScrollLayout;
...
//		OSChinaApi.getSoftwareCatalogList(mCurrentTag, handler);
        //new 临时
        OSChinaApi.getSoftWareAllList(mCurrentTag,handler);
	}
...
//				mSoftwareHandler);
        //new 临时
        OSChinaApi.getSoftWareAllList(mCurrentTag,mSoftwareHandler);
	}
