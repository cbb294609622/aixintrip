...
import net.aixin.app.bean.MyInformation;
...
import net.aixin.app.ui.MyQrodeDialog;
...
public class MyInformationFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        view.findViewById(R.id.rl_interest).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                UIHelper.showInterestMainActivity(getActivity());
            }
        });
...
//        OSChinaApi.getMyInformation(uid, mHandler);
        OSChinaApi.aixinGetMyInformation(uid,mHandler);
    }
