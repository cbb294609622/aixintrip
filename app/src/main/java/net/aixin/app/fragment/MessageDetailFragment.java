...
import net.aixin.app.adapter.MessageDetailAdapter;
...
import net.aixin.app.bean.MessageDetailList;
...
public class MessageDetailFragment extends BaseListFragment<MessageDetail> implements
    ...
    private void handleShowDate(List<MessageDetail> list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--) {
            msg = list.get(i);
            Date date = net.aixin.app.util.StringUtils.toDate(msg.getPubDate());
    ...
    private void sendMessage(MessageDetail msg){
        ...
        Date date = new Date();
        msg.setPubDate(net.aixin.app.util.StringUtils.getDateString(date));
